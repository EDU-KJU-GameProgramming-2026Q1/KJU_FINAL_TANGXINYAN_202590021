...
[System.Serializable]
public class IS_GameObjectEvent : UnityEvent<GameObject> { }
...
public class General_InterfaceBase : MonoBehaviour, IGeneral
{
    ...
    public IS_GameObjectEvent OnEnterEvent;

    [Tooltip("Action Event에서 작동시킬 1개 이상의 Actor를 연결할 수 있음")]
    public IS_GameObjectEvent OnStayEvent;

    [Tooltip("Exit Event에서 작동시킬 1개 이상의 Actor를 연결할 수 있음")]
    public IS_GameObjectEvent OnExitEvent;
